    ...
    return (
        <>
            <div className='mx-auto w-4/5'>
                <button  onClick={getUpdateNews} className=" px-5 py-2 bg-gray-700 text-white hover:bg-gray-600 rounded mt-10 shadow-xl">
                    Обновить
                </button>
            </div>
            <div className='mx-auto w-4/5 mt-10 bg-gray-200 h-full'>

                {news.map((item,index) => {
                    return   <div key={item.id} className='w-full h-13' >
